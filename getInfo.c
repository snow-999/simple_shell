#include "shell.h"
/**
 * clear_inf - clear the struct infromation
 * @info: struct
 *
*/
...
/**
 * set_inf - put the information in the struct
...
/**
 * free_inf - free the the struct info_t
 * @info: the struct informatioon
 * @all: all feilds
 *
*/
